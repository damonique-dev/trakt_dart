...
class Filters {
  ...
  Filters({this.query, this.years, this.runtime, this.ratings, this.genres, this.countries, this.languages});

  Map<String, String> toMap() {
    final map = <String, String>{};
    if (query != null) { map["query"] = query!; }
    if (years != null) { map["years"] = years!; }
    if (runtime != null) { map["runtime"] = runtime!; }
    if (ratings != null) { map["ratings"] = ratings!; }

    if (genres != null) { map["genres"] = genres!.join(","); }
    if (countries != null) { map["countries"] = countries!.join(","); }
...
class MovieFilters extends Filters {
  ...
  Map<String, String> toMap() {
    ...
    if (certifications != null) { map["certifications"] = certifications!.join(","); }
...
class ShowFilters extends Filters {
  ...
  Map<String, String> toMap() {
    final map = super.toMap();
    if (certifications != null) { map["certifications"] = certifications!.join(","); }
    if (networks != null) { map["networks"] = networks!.join(","); }
    if (status != null) { map["status"] = status!.map((e) => e.queryString).join(","); }
    return map;
  }
}
