...
extension SeasonRequests on TraktManager {
  ...
  Future<List<Comment>> getShowSeasonComments(String id, int seasonNumber, CommentsSortBy sortBy, {RequestPagination? pagination}) async {
    return await _getList("shows/$id/seasons/$seasonNumber/comments/${sortBy.toString()}", pagination: pagination);
  }

  Future<List<TraktList>> getShowSeasonLists(String id, int seasonNumber, ListType type, ListSort sortBy, {RequestPagination? pagination}) async {
